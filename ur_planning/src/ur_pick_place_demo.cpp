...
void place(moveit::planning_interface::MoveGroupInterface& group)
{
  ...
  place_location[0].pre_place_approach.direction.vector.z = -0.5;
...
//   collision_objects[3].id = "workstation";
...
//   collision_objects[3].primitives[0].dimensions[0] = 1.5;
//   collision_objects[3].primitives[0].dimensions[1] = 1.5;
//   collision_objects[3].primitives[0].dimensions[2] = 0.01;
...
{
  ros::init(argc, argv, "ur_pick_place");
  ros::NodeHandle nh;
